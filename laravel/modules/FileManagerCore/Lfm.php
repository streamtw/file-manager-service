...
class Lfm
{
    ...
    {
        $startup_view = $this->config->get('lfm.startup_view');
    ...
    {
        return $this->config->get('lfm.valid_mime');
    }

    public function shouldCreateCategoryThumb()
    {
        return $this->config->get('lfm.thumb');
    }

    public function categoryThumbWidth()
    {
        return $this->config->get('lfm.thumb_width');
    }

    public function categoryThumbHeight()
    {
        return $this->config->get('lfm.thumb_height');
    }

    public function maxUploadSize()
    {
        return $this->config->get('lfm.max_size');
    }
    ...
    {
        if ($this->config->has('lfm.allow_private_folder')) {
    ...
    public function allowShareFolder()
    {
        ...
        if ($this->config->has('lfm.allow_shared_folder')) {
